<template>
	...
	<div class="m-auto " id="github">
		<h1 class="text-2xl border-b-2 w-1/3 mb-4 text-center mx-auto border-b-white text-center text-white">Deployed Apps</h1>
			...
			axios.get("https://api.github.com/users/Kvasir111/repos").then(response =>
				{
					for (let index in response.data){
						if (response.data[index].homepage != null && response.data[index].homepage !== ""){
							this.gitLinks.push(
									{
										repoName : response.data[index].name,
										repoLink : response.data[index].homepage,
